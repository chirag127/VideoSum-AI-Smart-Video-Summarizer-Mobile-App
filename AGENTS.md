...
* **Tier 5 (Legacy/Specialized):**
    ...
    * `gemini-2.5-native-audio-preview-09-2025` (Audio I/O).
...
* **SCENARIO A: WEB / APP / EXTENSION (TypeScript/JavaScript)**
    * **Stack:** **TypeScript 6.x** (Strict), **Vite 7** (Rolldown), **React Native 0.7x** (Mobile), **Expo 5x** (Mobile Platform), **WXT** (Extensions).
